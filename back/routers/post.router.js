...
const {deleteOutdatedLocalPicture, handleFilesBeforeModify, sendPosts, makePost, sendPostCorrespondingToId, deletePost, modifyPost, likePost, getCommentsByParentId, createComment, deleteComment, modifyComment, getAllComments, getCommentsByPostId, consoleLogTest} = require("../controllers/posts.controller");
...
postRouter.put("/:id", /*matchingUserID,*/ upload.single('image'), handleFilesBeforeModify, modifyPost);//Modify a post and its corresponding local picture if it exists
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

//!!!!!!!!!!!!!!!!!!! getAllComments error : comment faire ? !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
postRouter.get("/getEverycomments", consoleLogTest, getAllComments);//Display all comments no matter where they were posted to easily moderate them.
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
postRouter.get("/:id/comments/", getCommentsByPostId);//Display all comments corresponding to a post id
